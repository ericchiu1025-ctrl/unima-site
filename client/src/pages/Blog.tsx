...
const posts = [
  {
    slug: "unima-weekly-61-ai-agent-control-plane",
    title: "AI Agent 已經失控了嗎？CIO 必須建立企業 AI 控制平面",
    excerpt: "你的 AI Agent 越多，企業就越安全嗎？答案是：沒有治理，只是在擴大風險。BCG 指出，agent 正以快於治理的速度進入各部門；權限不一致、資料外洩、無人負責，最後都會變成 CIO 的帳單。真正成熟的做法不是禁止 AI，而是建立企業 AI 控制平面：統一身分、政策、盤點與稽核，並用內建合規的標準路徑加速上線。AI 轉型不是多買工具，而是把信任納入架構。#AI治理 #AI決策轉型 #CIO #數位轉型",
    date: "2026-08-31",
    readTime: "3 分鐘",
  ...
  {
    slug: "unima-weekly-62-logistics-ai-roi",
    title: "為何只有 13% 物流企業拿到 AI 回報？問題在工作流，不在模型",
    excerpt: "物流業不是沒有 AI，而是 AI 沒有嵌進工作流。BCG 最新研究顯示，約三分之二物流企業已有 AI 預算，真正拿到財務成果的卻只有 13%。Flexport 的做法很直接：把海運拆成 100 多個任務，讓 agent 在報價、定價、放貨等節點各自負責，營運自動化超過 70%。結論很殘酷：AI 不會因為買進來就產生 ROI，只有重設流程、定義責任、量測結果，才會變成利潤。#AIROI #供應鏈 #COO #流程再造",
    date: "2026-08-31",
    readTime: "3 分鐘",
    tags: ["AI 決策轉型", "UNIMA", "2026 趨勢"],
    featured: true,
  ...
  {
    slug: "unima-weekly-63-ai-ebit-gap",
    title: "80% 員工說 AI 提升生產力，為何只有 37% 企業看到 EBIT？",
    excerpt: "員工每天都在用 AI，企業獲利卻沒有同步上升。McKinsey 2026 調查給出一個警訊：80% 說 AI 提升生產力，50% 說決策變好，但只有 37% 看到至少部分 EBIT 影響，高績效者約 6%。這代表「個人效率」不是「企業價值」。真正的 AI 轉型必須重設流程、資源配置與責任邊界，讓每一次更快的決策都能連到營收、成本或風險指標。#AI決策 #EBIT #CEO #企業轉型",
    date: "2026-08-31",
    readTime: "3 分鐘",
    tags: ["AI 決策轉型", "UNIMA", "2026 趨勢"],
    featured: true,
  ...
  {
    slug: "unima-weekly-64-global-ai-infrastructure",
    title: "AI 投資半年衝上 4,300 億美元：集團出海先搶算力，還是先搶市場？",
    excerpt: "AI 出海的第一個問題，不是要不要用模型，而是你的資料、雲端與合規能不能跨境運作。EY 指出，2026 上半年全球 AI VC 投資已達 4,300 億美元，資金正湧向資料中心、晶片、網路、能源與主權 AI。這表示全球競爭已從「誰有最酷的應用」轉向「誰掌握可控的基礎設施」。集團出海若仍各地各買系統，最後買到的是資料孤島與合規債。#集團出海 #主權AI #雲端架構 #跨境營運",
    date: "2026-08-31",
    readTime: "3 分鐘",
  ...
  {
    slug: "unima-weekly-65-data-sovereignty",
    title: "跨境 AI 的新門檻：誰能掌握「主權資料」，誰就掌握下一輪競爭力",
    excerpt: "資料主權不再只是法遵部門的問題，而是集團出海的競爭武器。EY 指出，AI 資金正轉向主權能力、資料中心與能源；歐洲 2026 年前五個月 AI 企業直接募資已達 213 億歐元。未來跨境營運比的不是誰把資料丟上雲最快，而是誰能清楚區分資料所在地、模型使用權與集團共享邊界。先做資料地圖，再談 AI 擴張，否則出海越快，風險越大。#資料主權 #跨境IT #集團治理 #AI策略",
    date: "2026-08-31",
    readTime: "3 分鐘",
    tags: ["集團出海", "UNIMA", "2026 趨勢"],
    featured: true,
  ...
  {
    slug: "unima-weekly-66-smb-ai-start",
    title: "大型企業 AI 採用率 58%，小型企業只有 17%：SMB 不該複製大公司的 AI",
    excerpt: "大型企業 AI 採用率 58%，小型企業只有 17%。這不是中小企業比較笨，而是一直用錯比較方式。SMB 不需要複製大型集團的複雜平台，應該先挑一個高頻、可量測、低整合成本的流程，例如報價、客服、對帳或庫存異常。先用 AI 解決一個真的會影響現金流的問題，再把成果複製到下一個流程。數位化不是比誰買得多，而是比誰更快把有限資源變成營運成果。#中小企業 #AI導入 #ERP #數位化",
    date: "2026-08-31",
    readTime: "3 分鐘",
