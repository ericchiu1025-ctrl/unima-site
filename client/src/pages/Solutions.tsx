...
const solutions = [
  {
    ...
    features: [
      { icon: Database, name: "ERP 進銷存系統規劃", detail: "涵蓋採購、銷售、庫存、研發管理等完整模組，支援鼎新、SAP、T100 等主流系統。" },
  ...
  },
  {
    ...
    desc: "利用生成式 AI 重塑企業決策節奏，從數據分析到策略建議，讓 AI 成為您最可靠的決策夥伴。",
    features: [
  ...
  },
  {
    ...
    desc: "針對貿易業與製造業，提供跨國人脈與市場分析，協助企業佈局新加坡、馬來西亞、澳洲等國際市場。",
    features: [
  ...
  },
  {
    ...
    features: [
      ...
      { icon: Cpu, name: "AI 課程與培訓", detail: "對接政府 AI 培訓資源，提升企業團隊的數位能力。" },
    ],
    ...
    <div>
      ...
      <section className="py-20 bg-gradient-to-br from-[oklch(0.14_0.04_250)] to-[oklch(0.18_0.04_250)]">
        <div className="container text-center">
          ...
          <p className="text-[oklch(0.7_0.02_250)] mt-3">讓我們的顧問團隊為您進行免費的需求評估。</p>
          <Link
            href="/contact"
