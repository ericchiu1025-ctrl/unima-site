...
const cases = [
  ...
  },
  {
    ...
    challenge: "年營收 20 億以上的集團企業，各單位意見分歧，數位轉型推動困難。公司保守文化與三家競爭者的激烈角逐。",
    solution: "整合 IoT 設備、APP 前台與數據管理後台，建立完整的數位轉型辦公室運作機制。以豐富的案例經驗與專業態度勝出。",
    results: ["2024 年 10 月啟動，2025 年 3 月底成功上線", "結合 AI + AR 規劃第二階段新市場", "獲得副總級高階主管的全力支持"],
    tag: "夢幻級專案",
  },
  {
    icon: Ship,
  ...
  },
  {
    ...
    challenge: "新成立的生醫子公司需要從零建立完整的 IT 基礎建設與企業管理系統。",
